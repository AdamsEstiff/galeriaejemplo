...
import cr.ac.unadeca.galeriaejemplo.database.Models.Imagen;
import cr.ac.unadeca.galeriaejemplo.fragments.FragmentRandomImage;
import cr.ac.unadeca.galeriaejemplo.fragments.FragmentRandomImageRX;
import cr.ac.unadeca.galeriaejemplo.subclases.ImageViewHolder;
import cr.ac.unadeca.galeriaejemplo.subclases.RunImage;
import cr.ac.unadeca.galeriaejemplo.util.Adapter;
import cr.ac.unadeca.galeriaejemplo.util.Functions;
import cr.ac.unadeca.galeriaejemplo.util.ImageAdapter;
import cr.ac.unadeca.galeriaejemplo.util.Session;
